...
| **Early lock-in** | Any retarget period where 55% of blocks signal (1,109 of 2,016 blocks) |
| **Mandatory lock-in** | ~August 2026 (if early lock-in has not occurred) |
| **Activation** | 2 weeks after lock-in |
| **Auto-expiry** | ~1 year after activation (52,416 blocks) |

Miners signal readiness using version bit 4. If 55% is not reached voluntarily before ~August 2026, mandatory signaling begins. After expiry, the rules automatically deactivate unless renewed.
