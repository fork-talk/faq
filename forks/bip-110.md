...
| Milestone | Block height | Approx. date |
|-----------|-------------|--------------|
...
| **Mandatory signaling** | 961,632 - 963,647 | ~August 2026 |
| **Lock-in (latest)** | 963,648 | ~August 2026 |
| **Activation (latest)** | 965,664 | ~September 1, 2026 |
| **Auto-expiry** | Activation + 52,416 blocks | ~1 year after activation |

Miners signal readiness using version bit 4. If 55% is reached in any retarget period, lock-in happens early. If not reached voluntarily, mandatory signaling begins at block 961,632. After expiry, the rules automatically deactivate unless renewed.
